...
public class InsertParentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insertparent);
        ...
        joinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(inputId.getText().toString().length()==0 )
                {
                    ...
                    new InsertParentActivity.JSONTask().execute(Helper.ServerAddress + "insertparent"); //AsyncTask 시작시킴
                }
            }
        });
